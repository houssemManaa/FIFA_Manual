# FC25 Tricks Manual (PS5) ⚽

An interactive web-based manual for learning FC25 (EA Sports Football Club 25) skill moves and tricks on PlayStation 5.
...
- **Video Tutorials**: Direct links to video demonstrations for each trick
...
- Vanilla JavaScript
- LocalStorage for user preferences and data persistence

## File Structure

- `index.html` - Main HTML structure
- `script.js` - JavaScript functionality and trick data
- `style.css` - Styling and themes
- Image assets for logo and controller layout
...
Made for young players • Keep practicing! ⚽
